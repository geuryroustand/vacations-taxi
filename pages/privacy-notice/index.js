...
export default function termsAndConditions() {
  return (
    <Container>
      <MyHead title="Privacy Notice" noIndex />
      <Suspense fallback={<FallBackLoading />}>
        <div className="mt-5">
          ...
          <p>
            ...
            Privacy Notice explains how we collect, use, and share personal information when you
          ...
          <p>
            ...
            through our website or app, including your name, contact information, payment details,
            and travel preferences. We also collect information about your location and movements
            during your trip, as well as details about your device, such as IP address and browser
            type.
          </p>
          <p>
            We may also collect information from third-party sources, such as social media
            platforms, to enhance our services and provide personalized recommendations.
          </p>

          <p>
            <b>Web browser cookies</b>Our Site may use &quot;cookies&quot; to enhance User
            experience. User&apos;s web browser places cookies on their hard drive for
            record-keeping purposes and sometimes to track information about them. User may choose
          ...
          <p>
            We use your personal information to process your bookings, communicate with you about
            your trip, and provide you with the best possible service. We may also use your
            information for research and analytics purposes, to improve our services and develop new
            products.
          </p>
          <p>
          ...
          <p>
            ...
            unsubscribe instructions at the bottom of each email or User may contact us via our
            Site. We may use third party service providers to help us operate our business and the
            Site or administer activities on our behalf, such as sending out newsletters or surveys.
          ...
          <p>
            ...
            or legal requirements. We will post any updates on this page, so please check back
            regularly to stay informed about how we are protecting your personal information.
          </p>
          <p>
            If you have any questions or concerns about our privacy practices, please do not
